...
namespace serdes
{
    ...
    {
        template <typename>
        struct is_std_atomic : eastl::false_type
        {
        };
        template <typename T>
        ...
        template <typename T>
        using requires_unsigned_type = typename eastl::enable_if<
            BITCPY_INT128_CONDITIONAL_DEFINE(
                eastl::is_same<T, __uint128_t>::value ||)(!eastl::is_same<T, char>::value && eastl::is_integral<T>::value && !eastl::is_same<T, bool>::value && !eastl::is_signed<T>::value) ||
                (eastl::is_same<T, char>::value && eastl::is_same<char, uint8_t>::value), // char is a special case, reinterpret it to uint8_t to reduce the template code generated if != uint8_t
            T>::type;
        template <typename T>
        using requires_bool_type = typename eastl::enable_if<
            eastl::is_same<T, bool>::value,
            T>::type;
        template <typename T>
        using requires_non_bool_type = typename eastl::enable_if<
            !eastl::is_same<T, bool>::value,
            T>::type;
        template <typename T>
        using requires_signed_type = typename eastl::enable_if<
            BITCPY_INT128_CONDITIONAL_DEFINE(eastl::is_same<T, __int128_t>::value ||)(!eastl::is_same<T, char>::value && eastl::is_integral<T>::value && !eastl::is_same<T, bool>::value && eastl::is_signed<T>::value) ||
                (eastl::is_same<T, char>::value && !eastl::is_same<char, uint8_t>::value), // char is a special case, reinterpret it to uint8_t to reduce the template code generated if != uint8_t
            T>::type;
        template <typename T>
        using requires_large_non_integral_type = typename eastl::enable_if<
            (sizeof(T) > 8) &&
                BITCPY_INT128_CONDITIONAL_DEFINE(!eastl::is_same<T, __uint128_t>::value &&
                                                 !eastl::is_same<T, __int128_t>::value &&) !is_sized_pointer<T>::value,
            T>::type;
        template <typename T>
        using requires_small_non_integral_type = typename eastl::enable_if<
            (sizeof(T) <= 8) &&
                BITCPY_INT128_CONDITIONAL_DEFINE(!eastl::is_same<T, __uint128_t>::value &&
                                                 !eastl::is_same<T, __int128_t>::value &&) !eastl::is_integral<T>::value &&
                !eastl::is_same<T, bool>::value &&
                !is_std_atomic<T>::value &&
                !is_sized_pointer<T>::value,
            T>::type;
        template <typename T>
        using requires_pointer_type = typename eastl::enable_if<
            eastl::is_pointer<T>::value,
            T>::type;
        template <typename T>
        using requires_not_a_pointer_type = typename eastl::enable_if<
            !eastl::is_pointer<T>::value,
            T>::type;
        ...
        {
            using Tunsigned = typename eastl::make_unsigned<T>::type;
